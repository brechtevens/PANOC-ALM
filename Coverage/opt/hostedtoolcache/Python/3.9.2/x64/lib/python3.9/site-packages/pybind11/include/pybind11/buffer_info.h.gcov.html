...
<head>
  ...
  <title>LCOV - e2ddd1370d03a5ab3ddb595e4622fa04196c5f40 - /opt/hostedtoolcache/Python/3.9.2/x64/lib/python3.9/site-packages/pybind11/include/pybind11/buffer_info.h</title>
      ...
      <td width="100%">
        <table cellpadding=1 border=0 width="100%">
          <tr>
            ...
            <td width="35%" class="headerValue"><a href="../../../../../../../../../../../index.html">top level</a> - <a href="index.html">opt/hostedtoolcache/Python/3.9.2/x64/lib/python3.9/site-packages/pybind11/include/pybind11</a> - buffer_info.h<span style="font-size: 80%;"> (source / <a href="buffer_info.h.func-sort-c.html">functions</a>)</span></td>
            <td width="5%"></td>
            <td width="15%"></td>
...
<a name="20"><span class="lineNum">      20 </span><span class="lineNoCov">          0 :     auto ndim = shape.size();</span></a>
...
<a name="52"><span class="lineNum">      52 </span>            :     buffer_info(void *ptr, ssize_t itemsize, const std::string &amp;format, ssize_t ndim,</a>
...
<a name="54"><span class="lineNum">      54 </span>            :     : ptr(ptr), itemsize(itemsize), size(1), format(format), ndim(ndim),</a>
<a name="55"><span class="lineNum">      55 </span>            :       shape(std::move(shape_in)), strides(std::move(strides_in)), readonly(readonly) {</a>
<a name="56"><span class="lineNum">      56 </span>            :         if (ndim != (ssize_t) shape.size() || ndim != (ssize_t) strides.size())</a>
<a name="57"><span class="lineNum">      57 </span>            :             pybind11_fail(&quot;buffer_info: ndim doesn't match shape and/or strides length&quot;);</a>
<a name="58"><span class="lineNum">      58 </span>            :         for (size_t i = 0; i &lt; (size_t) ndim; ++i)</a>
<a name="59"><span class="lineNum">      59 </span>            :             size *= shape[i];</a>
...
<a name="77"><span class="lineNum">      77 </span>            :     explicit buffer_info(Py_buffer *view, bool ownview = true)</a>
<a name="78"><span class="lineNum">      78 </span>            :     : buffer_info(view-&gt;buf, view-&gt;itemsize, view-&gt;format, view-&gt;ndim,</a>
<a name="79"><span class="lineNum">      79 </span>            :             {view-&gt;shape, view-&gt;shape + view-&gt;ndim},</a>
...
<a name="83"><span class="lineNum">      83 </span>            :             view-&gt;strides</a>
<a name="84"><span class="lineNum">      84 </span>            :             ? std::vector&lt;ssize_t&gt;(view-&gt;strides, view-&gt;strides + view-&gt;ndim)</a>
<a name="85"><span class="lineNum">      85 </span>            :             : detail::c_strides({view-&gt;shape, view-&gt;shape + view-&gt;ndim}, view-&gt;itemsize),</a>
<a name="86"><span class="lineNum">      86 </span>            :             (view-&gt;readonly != 0)) {</a>
<a name="87"><span class="lineNum">      87 </span>            :         this-&gt;m_view = view;</a>
<a name="88"><span class="lineNum">      88 </span>            :         this-&gt;ownview = ownview;</a>
